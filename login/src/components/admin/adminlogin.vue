<template>
    <div class="adminloginback">
      <div class="adminloginbox">
        ...
        <input type="text" id="account" placeholder="Username" v-model="account" required >
  ...
  <style scoped>
    ...
    .adminloginbox input[type="text"]:focus,
    .adminloginbox input[type="password"]:focus {
        width: 280px;
        border-color: #2ecc71;
    }

    .adminloginbox input[type="button"] {
            border: 0;
            background: none;
            display: block;
            margin: 20px auto;
        ...
        .adminloginbox input[type="button"]:hover {
            background: #2ecc71;
        }
  </style>